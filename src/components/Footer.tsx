        ...
        <div className="footer-col footer-contact">
          ...
          <div className="footer-contact-rows">
            <div className="footer-contact-row">
              ...
              <a className="footer-contact-value" href="tel:+19497924283">(949) 989 5597</a>
            </div>
            <div className="footer-contact-row">
        ...
        <div className="container footer-bar-inner">
          ...
          <ul className="footer-legal">
            <span className="footer-credits">
              Made With ❤️ by <a href="https://vertexmediahouse.com/" target="_blank" rel="noopener noreferrer">Vertexmediahouse</a>
            </span>
          </ul>
        </div>
      </div>
