...
const QUESTION_LABELS: Record<string, string> = {
  ...
  'crack_repair_wall_lft':        'Crack repair wall (per lft by height)',
  'crack_repair_ceiling_lft':     'Crack repair ceiling (per lft by height)',
...
const SECTIONS = [
  {
    ...
    title: 'Drywall',
    icon: '🧱',
    questions: ['drywall', 'dividing_wall', 'crack_repair_wall_under_5', 'crack_repair_ceiling_under_5', 'crack_repair_wall_lft', 'crack_repair_ceiling_lft'],
  },
  {
    id: 'sec_location',
