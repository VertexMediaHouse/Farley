...
var init_apify_scrape = __esm({
  "api/apify-scrape.js"() {
    init_functionsRoutes_0_04704912075285583();
...
async function onRequestPost3(context) {
  ...
  try {
      ...
      ">
        ...
        ">
          ...
          <h2 style="
            font-size:16px;
            color:#0f172a;
            border-bottom:2px solid #2F9BF0;
            padding-bottom:8px;
            margin:0 0 16px;
          ">
            Customer Information
    ...
    const resendApiKey = env.RESEND_API_KEY || "re_xxxxxxxxx";
...
// ../.wrangler/tmp/pages-THTCyN/functionsRoutes-0.04704912075285583.mjs
var routes;
var init_functionsRoutes_0_04704912075285583 = __esm({
  "../.wrangler/tmp/pages-THTCyN/functionsRoutes-0.04704912075285583.mjs"() {
    init_apify_scrape();
    init_chat();
...
// ../.wrangler/tmp/bundle-MoetrI/middleware-loader.entry.ts
init_functionsRoutes_0_04704912075285583();

// ../.wrangler/tmp/bundle-MoetrI/middleware-insertion-facade.js
init_functionsRoutes_0_04704912075285583();
...
//# sourceMappingURL=functionsWorker-0.6984048332910304.mjs.map
